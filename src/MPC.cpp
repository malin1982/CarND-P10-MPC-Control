...
const double ref_cte = 0.0;  // desired cross track error
const double ref_epsi = 0.0; // desired epsi
const double ref_v = 65.0;   // desired max speed

// variables' starting position
size_t x_start = 0;
